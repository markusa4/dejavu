...
assert(c->cells == actual_cells);
            ...
            std::pair<bool, int>  __attribute__ ((noinline))
            certify_automorphism_sparse_report_fail(const sgraph *g, const int *colmap, const int *p, int supp,
                                                    const int *supp_arr) {
                int i, found;
...
assert(c->cells == actual_cells);
            ...
            // certify an automorphism on a graph, sparse
            bool __attribute__ ((noinline))
            certify_automorphism_sparse(const dejavu::graph *g, const int *p, int supp, const int *supp_arr) {
                int i, found;
            ...
            // certify an automorphism on a graph, sparse
            bool __attribute__ ((noinline))
            certify_automorphism_sparse(const dejavu::graph *g, const int *colmap, const int *p, int supp,
                                        const int *supp_arr) {
                int i, found;
            ...
            // certify an automorphism on a graph, sparse, report on which vertex failed
            std::pair<bool, int>  __attribute__ ((noinline))
            certify_automorphism_sparse_report_fail(const dejavu::graph *g, const int *colmap, const int *p, int supp,
                                                    const int *supp_arr) {
                int i, found;
            ...
            // certify an automorphism on a graph, sparse, report on which vertex failed
            std::tuple<bool, int, int>
            certify_automorphism_sparse_report_fail_resume(const dejavu::graph *g, const int *colmap, const int *p,
                                                           int supp, const int *supp_arr, int pos_start) {

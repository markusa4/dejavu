...
public:
     ...
     * @return
     */
    int  individualize_vertex(coloring* c, int v, const std::function<type_split_color_hook>& split_hook = nullptr) {
...
public:
    ...
    // color refinement that does not produce an isomorphism-invariant partitioning, but uses more optimization
    // techniques -- meant to be used as the first refinement in automorphism computation
    bool refine_coloring_first(dejavu::graph *g, coloring *c, int init_color_class = -1) {
        assure_initialized(g);
        singleton_hint.reset();
    ...
    // certify an automorphism on a graph
    bool certify_automorphism(dejavu::graph  *g, bijection *p) {
        assert(p->map_sz == g->v_size);
        int i, found;
    ...
    // certify an automorphism on a graph
    bool certify_automorphism(dejavu::graph  *g, const int* p) {
        int i, found;
    ...
    // certify an automorphism on a graph
    bool certify_automorphism(dejavu::graph *g, const int* colmap, const int* p) {
        int i, found;
    ...
    // certify an automorphism on a graph, sparse
    bool __attribute__ ((noinline)) certify_automorphism_sparse(const dejavu::graph *g, const int* p, int supp, const int* supp_arr) {
        int i, found;
    ...
    // certify an automorphism on a graph, sparse
    bool __attribute__ ((noinline)) certify_automorphism_sparse(const dejavu::graph *g, const int* colmap, const int* p, int supp, const int* supp_arr) {
        int i, found;
    ...
    // certify an automorphism on a graph, sparse, report on which vertex failed
    std::pair<bool, int>  __attribute__ ((noinline)) certify_automorphism_sparse_report_fail(const dejavu::graph  *g, const int* colmap, const int* p, int supp, const int* supp_arr) {
        int i, found;
    ...
    // certify an automorphism on a graph, sparse, report on which vertex failed
    std::tuple<bool, int, int> certify_automorphism_sparse_report_fail_resume(const dejavu::graph  *g, const int* colmap, const int* p, int supp, const int* supp_arr, int pos_start) {
    ...
    // certify an automorphism, for a single vertex
    bool  check_single_failure(const dejavu::graph  *g, const int* colmap, const int* p, int failure) {
        assure_initialized(g);
    ...
    // certify an automorphism on a graph
    bool certify_automorphism_iso(dejavu::graph *g, bijection *p) {
        assert(p->map_sz == g->v_size);
        int i, found;
...
private:
    ...
    void assure_initialized(const dejavu::graph  *g) {
        if(!initialized) {
            const int n = g->v_size;
    ...
    bool refine_color_class_dense(dejavu::graph  *g, coloring *c,
                                  int color_class, int class_size,
                                  work_list_pair_bool* color_class_split_worklist) {
        bool comp;
        int i, cc, acc, largest_color_class_size, singleton_inv, pos;
    ...
    bool refine_color_class_dense_dense(dejavu::graph *g, coloring *c,
                                        int color_class, int class_size,
                                        work_list_pair_bool* color_class_split_worklist) {
        bool comp;
        int i, j, acc, cc, largest_color_class_size;
    ...
    bool refine_color_class_singleton_first(dejavu::graph  *g, coloring *c,
                                            int color_class, int class_size,
                                            work_list_pair_bool *color_class_split_worklist) {
        bool comp;
        int i, cc, deg1_write_pos, deg1_read_pos;
    ...
    bool refine_color_class_dense_first(dejavu::graph  *g, coloring *c,
                                        int color_class, int class_size,
                                        work_list_pair_bool *color_class_split_worklist) {
        int i, cc, acc, largest_color_class_size, pos;
        cc = color_class; // iterate over color class
    ...
    bool refine_color_class_dense_dense_first(dejavu::graph  *g, coloring *c,
                                              int color_class, int class_size,
                                              work_list_pair_bool *color_class_split_worklist) {
        // for all vertices of the color class...
        int i, j, cc, acc, largest_color_class_size, pos;
    ...
    bool refine_color_class_sparse_first(dejavu::graph  *g, coloring *c,
                                         int color_class, int class_size,
                                         work_list_pair_bool* color_class_split_worklist) {
        bool comp;
        int v_new_color, cc, largest_color_class_size, acc;
